...
UPLOAD_FOLDER = Path(os.getenv("UPLOAD_DIR", tempfile.gettempdir())) / "latex_generator_uploads"
...
class OllamaLatexGenerator:
    def __init__(self, model=MODEL_NAME):
        self.model = model
        self.client = Client(host=os.getenv('OLLAMA_API_HOST', 'http://localhost:11434'))
